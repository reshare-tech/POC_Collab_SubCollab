...
class SubCollab_2_3 extends StatefulWidget {
  @override
  _SubCollab_2_3State createState() => _SubCollab_2_3State();
}

class _SubCollab_2_3State extends State<SubCollab_2_3> {
                  ...
                  children: [
                    ...
                    Positioned(
                        child: Text(
                          ...
                          style:
                              TextStyle(fontSize: 12, color: Color(0xfffdfdfd)),
                        ),
                        top: 75,
                        left: 43),
                    Positioned(
                            ...
                            Positioned(
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                      validator: (value) {
                                        if (value.length <= 0)
                                          return "Please enter a Sub-Collab name";
                                      },
